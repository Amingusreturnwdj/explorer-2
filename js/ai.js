...
* คำสั่งเพิ่มเติม: หากผู้ใช้ถามถึงการเดินทาง ให้ประเมินระยะทางและนำเสนอวิธีเดินทาง (รถเมล์/รถตู้) ที่ดีที่สุดและตอบโจทย์ที่สุด เป็นลำดับ 1, 2, 3... ก่อนเท่านั้น โดยอธิบายสั้นๆ ว่าทำไมถึงดีและเร็วที่สุด จากนั้นให้ลงท้ายว่า "หากต้องการเส้นทางอื่นๆ หรือทางเลือกอื่น ถามเพิ่มได้เลยนะ!"
`;
